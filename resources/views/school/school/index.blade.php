...
<div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="font-size: 30px;text-align: center;">Teachers</h4>
                    <div class="media">
                     {{--  <i class="mdi mdi-earth icon-md text-info d-flex align-self-start mr-3"></i> --}}
                      <div class="media-body">
                        <p class="card-text" style="text-align: center;font-size: 50px;font-weight: bold">{{ $teachers }}</p>
                      </div>
                    </div>
                  </div>
                </div>
