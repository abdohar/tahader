...
<div class="col-12 grid-margin">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form class="form-sample"action="{{ route('school.update.profile',['school' => $school->id]) }}" method="POST" enctype="multipart/form-data">
                  {{csrf_field()}}
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="email" disabled="" value="{{ $school->school_email }}" name="school_email" class="form-control">
                            </div>
                          </div>
                      </div>
                    </div>
