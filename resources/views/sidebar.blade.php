            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.school.index') }}">Schools Show</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.school.create') }}">School Add</a>
                  </li>
                  <li class="nav-item">
             ...
             <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.school.message') }}">
                <i class="menu-icon typcn typcn-shopping-bag"></i>
                <span class="menu-title">School Message </span>
              </a>
            </li>
            <li class="nav-item">
